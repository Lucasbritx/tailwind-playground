...
function BreakBefore() {
  return (
    <div className="mt-4 bg-amber-700 p-4 space-y-6">
      <h2 className="text-xl font-bold text-white">Break Before Examples</h2>

      <div>
        <h3 className="text-white mb-2">
          With break-before-column on Paragraph 2(same behavior as break-after
          in Paragraph 1):
        </h3>
        <div className="columns-2 gap-4 bg-amber-900 p-3">
          <p className="bg-blue-500 p-2 mb-2">Paragraph 1</p>
          <p className="bg-green-500 p-2 mb-2 break-before-column">
